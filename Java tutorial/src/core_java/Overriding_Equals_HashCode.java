...
class Geek {
	...
	public boolean equals(Object obj) {
		...
		// of the passed argument and this object. if(!(obj instanceof Geek)) return false; ---> avoid.
	...
	public int hashCode() {
		...
		// We are returning the Geek_id as a hashcode value. we can also return some other calculated value or may
...
public class Overriding_Equals_HashCode {
